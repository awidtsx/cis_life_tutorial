class BranchOfficesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @branch_office.update(branch_office_params)
        format.html { redirect_to @branch_office, notice: "Branch office was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to branch_offices_path, notice: "Branch office was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def branch_office_params
      params.require(:branch_office).permit(:name, :territory_id)
    end
end
