class ProducersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @producer.update(producer_params)
        format.html { redirect_to @producer, notice: "Producer was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to producers_path, notice: "Producer was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def producer_params
      params.require(:producer).permit(:first_name, :last_name, :title)
    end
end
