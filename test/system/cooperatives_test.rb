...
class CooperativesTest < ApplicationSystemTestCase
  ...
  test "should create cooperative" do
    ...
    fill_in "Add barangay", with: @cooperative.add_barangay_id
    fill_in "Add municipal", with: @cooperative.add_municipal_id
    fill_in "Add province", with: @cooperative.add_province_id
    fill_in "Add region", with: @cooperative.add_region_id
