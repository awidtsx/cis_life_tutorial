...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference("Producer.count") do
      post producers_url, params: { producer: { first_name: @producer.first_name, last_name: @producer.last_name, title: @producer.title } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { first_name: @producer.first_name, last_name: @producer.last_name, title: @producer.title } }
