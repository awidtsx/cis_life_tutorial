...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference("Registry.count") do
      post registries_url, params: { registry: { cooperative_id: @registry.cooperative_id, name: @registry.name } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { cooperative_id: @registry.cooperative_id, name: @registry.name } }
