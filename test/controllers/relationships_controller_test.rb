...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference("Relationship.count") do
      post relationships_url, params: { relationship: { contract_id: @relationship.contract_id, relationship: @relationship.relationship } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { contract_id: @relationship.contract_id, relationship: @relationship.relationship } }
