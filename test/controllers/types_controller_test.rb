...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference("Type.count") do
      post types_url, params: { type: { cooperative_id: @type.cooperative_id, name: @type.name } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { cooperative_id: @type.cooperative_id, name: @type.name } }
